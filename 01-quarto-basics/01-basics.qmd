...
1.  Add some executable R code or verbatim code

2.  Add some **numbered list** and **non-numbered list**, using the *visual editor.* Switch back to the *markdown editor* and take note of the syntax. Try creating lists using codes as well.

3.  Add a piece of text and **hyperlink** it to a URL.

4.  Insert the **image** of a cat cafe into your report. The path to the image is `01-quarto-basics/cat-cafe.jpg`
