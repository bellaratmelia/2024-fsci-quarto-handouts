...
Use the Quarto document you created earlier, try different **YAML options** and **render** the document to see the resulting changes on the output document. Make sure to have different level headings, some text, and some codes - you can copy the [sample code chunk](#sample-code) below.
