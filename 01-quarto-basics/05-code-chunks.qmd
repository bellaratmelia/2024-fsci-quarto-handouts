...
1.  Consider the following header options
2.  Amend the header of the following code chunks to fit their description
...
1.  Convert the comments inside the code chunks below into annotations.
