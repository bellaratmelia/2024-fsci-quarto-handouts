...
Below is a list of changes that we need to make to the slides. Be sure to re-render the document again after you completed each change to see the changes.

1.  Amend the YAML header in this document to include the following options:
